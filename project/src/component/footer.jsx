                        ...
                        <div className="col-xl-5 col-lg-7 col-md-9 col-sm-11">
                            <div className="footer__info text-center">
                                <div className="footer-logo">
                                    <a href="index.html"><img src="/assets/img/logo/nerko.svg" width="200" alt="Nerko" /></a>
                                </div>
                                ...
                                <div className="copyright__menu">
                                    <ul className="list-wrap">
                                        ...
                                        <li className="backTop">
                                            <a href="" className="scroll-to-target" data-target="html"><i className="flaticon-arrowhead-up"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
